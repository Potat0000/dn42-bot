...
def update_china_ip():
    try:
        ChinaIPv4_RAW = requests.get(
            'https://raw.githubusercontent.com/misakaio/chnroutes2/master/chnroutes.txt', timeout=30
        ).text
        base.ChinaIPv4 = [
        ...
        pass
    try:
        ChinaIPv6_RAW = requests.get('https://ispip.clang.cn/all_cn_ipv6.txt', timeout=30).text
